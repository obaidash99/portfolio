...
!(function (t, e) {
	...
	var b = {},
		...
		mt = function (t, e) {
			e
				? lt(t, arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 'flex')
				: dt(t);
		},
		ht = function (t) {
	...
	function ve(t, e, n, o) {
		Q()
			...
			G() &&
				(null !== me &&
					((document.body.style.paddingRight = ''.concat(me, 'px')), (me = null)),
				(function () {
	...
	var fn = function (t) {
		...
		Cn = function (t, e, n) {
			e.container.onclick = function (o) {
				bn
					? (bn = !1)
					: o.target === e.container && S(t.allowOutsideClick) && n(Xt.backdrop);
			};
		},
		An = function (e) {
			return (
	...
	var Zn = new WeakMap(),
		...
		Xn = function (t, e) {
			var n = (function (t) {
					...
					var n = e.content;
					return (
						Rn(n), Object.assign(jn(n), Mn(n), In(n), Hn(n), Dn(n), qn(n), Vn(n, Ln))
					);
				})(t),
